...
class CustomerLoanApplicationSummary(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class CustomerDepositApplicationSummary(BaseModel):
    model_config = ConfigDict(from_attributes=True)
...
class CustomerSummary(BaseModel):
    ...
    mobile: str | None
    email: str | None
    loan_applications: list[CustomerLoanApplicationSummary]
    deposit_applications: list[CustomerDepositApplicationSummary]
